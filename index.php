	...
	<div class="f-widget featpro">
		<div class="container">
			...
			<div id="product-carousel" class="owl-carousel owl-theme">
				...
				$urunsor = $db->prepare("SELECT * FROM urun where urun_durum =:urun_durum and urun_onecikan =:urun_onecikan");
				...
				?>
					...
					<div class="item">
						<div class="productwrap">
							<div class="pr-img">
								<div class="hot"></div>
								<a href="urun-<?= seo($uruncek["urun_ad"]) . '-' . ($uruncek["urun_id"]) ?>"><img width="200" src="<?php echo  $urunfotocek['urunfoto_resimyol']; ?>" alt="" class="img-responsive"></a>
