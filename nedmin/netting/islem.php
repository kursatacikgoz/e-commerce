	...
	if ($kullanici_passwordone == $kullanici_passwordtwo) {
		...
		if ($kullanici_passwordone >= 6) {
			...
			if ($say == 0) {
				...
				header("Location:../../register.php?durum=kayitlikullanici");
			}
			...
			header("Location:../../register.php?durum=");
		}
	} else {



		header("Location:../../register.php?durum=eslesmeyensifre");
	}
}
...
if (isset($_POST['sliderkaydet'])) {
	...
	if ($insert) {
		...
		Header("Location:../production/slider.php?durum=fail");
	}
}
...
if ($_GET['slidersil'] == "ok") {
	...
	if ($kontrol) {
		...
		header("Location:../production/slider.php?sil=fail");
	}
}
...
if (isset($_POST['menuduzenle'])) {
	...
	if ($update) {
		...
		Header("Location:../production/menu-duzenle.php?menu_id=$menu_id&durum=fail");
	}
}
...
if (isset($_POST['sliderduzenle'])) {
	...
	if ($update) {
		...
		header("Location:../production/slider-duzenle.php?slider_id=$slider_id&durum=fail");
	}
}
...
if (isset($_POST['kategoriduzenle'])) {
	...
	if ($update) {
		...
		Header("Location:../production/kategori-duzenle.php?durum=fail&kategori_id=$kategori_id");
	}
}
...
if (isset($_POST['kategoriekle'])) {
	...
	if ($insert) {
		...
		Header("Location:../production/kategori.php?durum=fail");
	}
}
...
if (isset($_POST['urunduzenle'])) {
	...
	if ($update) {
		...
		Header("Location:../production/urun-duzenle.php?durum=fail&urun_id=$urun_id");
	}
}
...
if (isset($_POST['userupdatepasssword'])) {
	...
	echo $kullanici_oldpassword = trim($_POST['kullanici_oldpassword']);
	echo "<br>";
...
if (isset($_POST['addbankorder'])) {
	...
	if ($insert) {
		...
		if ($insert) {
			...
			// if process complated make empty the cart
